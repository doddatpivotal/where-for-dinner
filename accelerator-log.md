...
```json
{
  ...
  "serviceNamespace" : "rabbitmq-service-instances",
  "workloadNamespace" : "cody"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"artifactVersion":"0.0.1-beta","dbName":"db-where-for-dinner","dbType":"h2","rabbitMQName":"rmq-where-for-dinner","enableCloudEvents":false,"enableSecurity":false,"cacheName":"cache-where-for-dinner","numRabbitMQClusterNodes":1,"artifactId":"where-for-dinner","serviceNamespace":"rabbitmq-service-instances","projectName":"where-for-dinner","workloadNamespace":"cody","cacheType":"inmemCache"}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input14949562670919726767, --data-values-file, /tmp/accelerator-options660297586637550439.json, --output-files, /tmp/ytt-output15108725926612670740]
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"artifactVersion":"0.0.1-beta","dbName":"db-where-for-dinner","dbType":"h2","rabbitMQName":"rmq-where-for-dinner","enableCloudEvents":false,"enableSecurity":false,"cacheName":"cache-where-for-dinner","numRabbitMQClusterNodes":1,"artifactId":"where-for-dinner","serviceNamespace":"rabbitmq-service-instances","projectName":"where-for-dinner","workloadNamespace":"cody","cacheType":"inmemCache"}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input12650344149674070247, --data-values-file, /tmp/accelerator-options2737592416824308181.json, --output-files, /tmp/ytt-output6409656111635838376]
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"artifactVersion":"0.0.1-beta","dbName":"db-where-for-dinner","dbType":"h2","rabbitMQName":"rmq-where-for-dinner","enableCloudEvents":false,"enableSecurity":false,"cacheName":"cache-where-for-dinner","numRabbitMQClusterNodes":1,"artifactId":"where-for-dinner","serviceNamespace":"rabbitmq-service-instances","projectName":"where-for-dinner","workloadNamespace":"cody","cacheType":"inmemCache"}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input4598069125234439078, --data-values-file, /tmp/accelerator-options8410199248388637809.json, --output-files, /tmp/ytt-output3768511870734444588]
